...
public class Main {
	...
	private static void inputSelector(int userInput) {
	...
	public static void addRecipe() {
	    ...
	    recipeAdder(name, price, amtCoffee, amtMilk, amtSugar, amtChocolate);
    }
	private static void recipeAdder(String name, int price, int amtCoffee, int amtMilk, int amtSugar,
			int amtChocolate) {
    ...
    public static void editRecipe() {
	    ...
	    recipeEditer1(oldRecipe, name, price, amtCoffee);
    }
	private static void recipeEditer1(Recipe oldRecipe, String name, int price, int amtCoffee) {
		//Read in amt milk
	    String milkString = inputOutput("Please enter the units of milk in the recipe: ");
	    int amtMilk = stringToInt(milkString);
	    if(amtMilk < 0) {
